package com.sbarifp.pemasaranproduk.presentation.detailproduct
...
import com.sbarifp.pemasaranproduk.databinding.ActivityDetailProductBinding
...
class DetailProductActivity : AppCompatActivity() {
    ...
    private fun onAction() {
        ...
        binding.btnCall.setOnClickListener {
            val number = "+628999488990"
            val dialogPhoneIntent = Intent(Intent.ACTION_DIAL, Uri.parse("tel:$number"))
            startActivity(dialogPhoneIntent)
