...
import com.sbarifp.pemasaranproduk.data.model.product.DataProduct
import com.sbarifp.pemasaranproduk.data.model.product.ImageProduct
import com.sbarifp.pemasaranproduk.databinding.ActivityUploadPhotoBinding
import com.sbarifp.pemasaranproduk.presentation.main.MainActivity
import com.sbarifp.pemasaranproduk.utils.getRealPath
...
class UploadPhotoActivity : AppCompatActivity() {
    ...
    private fun uploadPhotoToServer(images: ArrayList<ImageProduct?>) {
        ...
        for (image in images){
            ...
            if (uri != null && path != null){
                ...
                imageParts.add(multipartBody)
            }
        }

        val id = dataProduct.id

        uploadPhotoViewModel.uploadImages(token, id!!, imageParts).observe(this){ state->
            when(state){
                Resource.Empty -> {
    ...
    private fun checkPermissionStorahe(): Boolean {
